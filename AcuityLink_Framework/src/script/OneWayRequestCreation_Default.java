...
public class OneWayRequestCreation_Default extends BaseTest {
	...
	public void createRequestProcess() throws InterruptedException, AWTException {
		...
		create.sendDestinationAddress(destAdd, driver);
		...
		create.checkReviewPage(driver);
		create.clickNonRepeatSubmit();
